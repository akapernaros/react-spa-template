        ...
        return (
            <div>
                ...
                <div className="App container-lg">
                    ...
                    <div className="row py-4">
                        <div className="col">
                            <Widget.ExpandableSection title={this.props.t('app.labels.twoway')} expanded={true}>
                                <Widget.ExpandableTabBody>
                                    <div className="input-group my-3">
                                        <span className="input-group-text"><Trans>app.text.twoway</Trans></span>
                                    </div>
                                    <div className="input-group my-3">
                                        <div className="input-group-prepend">
                                            <span
                                                className="input-group-text"><Trans>app.labels.textinput</Trans></span>
                                        </div>
